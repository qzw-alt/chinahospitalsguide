...
title: "Gentle Electroacupuncture Matches Strong Current for Long-Term Facial Paralysis: 2026 Chinese RCT"
description: "A 2026 randomised trial from Guangzhou University of Chinese Medicine found gentle electroacupuncture worked as well as strong stimulation for chronic facial paralysis, with 66 patients across three arms. What the finding changes for international patients considering acupuncture in China."
kicker: "TCM Evidence Update"
...
ogType: "article"
ogTitle: "Gentle Electroacupuncture Matches Strong Current for Facial Paralysis: 2026 Chinese RCT"
ogDescription: "A 66-patient Chinese RCT found barely perceptible electroacupuncture currents worked almost as well as strong stimulation for chronic facial paralysis. Mechanism, access and what to ask Chinese hospitals."
  ...
  [
    {
      ...
      "@type": "Article",
      "headline": "Gentle Electroacupuncture Matches Strong Current for Long-Term Facial Paralysis: 2026 Chinese RCT",
      "description": "A 2026 randomised trial from Guangzhou University of Chinese Medicine found gentle electroacupuncture worked as well as strong stimulation for chronic facial paralysis, with 66 patients across three arms. What the finding changes for international patients considering acupuncture in China.",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://chinahospitalsguide.com/blog/2026-07-27-electroacupuncture-facial-paralysis-gentle-current-china-rct-2026.html"
      }
    },
    {
      "@context": "https://schema.org",
...
pageStyle: |
  .rct-box { background:#f4f8f6; border-left:4px solid #1f6f5c; padding:1rem 1.2rem; margin:1.4rem 0; }
  .methodology-note { font-size:.92rem; color:#555; }
  .source-note { background:#fff8e6; padding:1rem 1.2rem; border-radius:8px; }
---
...
![Electroacupuncture for facial paralysis in Chinese TCM hospital](/og-image.webp)

<div class="rct-box">
<strong>What the trial actually did:</strong> 66 patients with unilateral facial paralysis lasting at least three months. Three arms: strong current (visible twitching), gentle current (barely perceptible), and sham current (no active stimulation). Twenty electroacupuncture treatments, one every three days. Same needle protocol across all three groups. The blink reflex — measurable in the clinic — was used as a brainstem recovery marker. Source: <a href="https://doi.org/10.13702/j.1000-0607.20240877">doi.org/10.13702/j.1000-0607.20240877</a>, summarised by <a href="https://www.deccanherald.com/health/healthcare/explained-facial-paralysis-how-gentle-electroacupuncture-may-boost-nerve-repair-4083259">Deccan Herald</a> on 22 July 2026.
</div>
...
A full pre-travel checklist, including how to submit records and request a written quote, is in our [acupuncture treatment in China guide](/blog/acupuncture-treatment-china-2026.html) and our [TCM guide for international patients](/blog/tcm-traditional-chinese-medicine-guide.html).
...
<p class="cost-note">These are planning benchmarks, not quotes. Final cost depends on hospital tier, city, the supervising physician, and whether a translator and a Western neurology workup are bundled. Travel, accommodation and any simultaneous Western treatment are not included.</p>

For patients in Southeast Asia, the Middle East, Russia, Central Asia or Africa, the cost ratio is what tends to matter most. The same protocol in Singapore or in private clinics in the Gulf can run 2 to 4 times the Chinese self-pay benchmark, without the in-house rehabilitation team that a Chinese TCM university hospital brings to the table. Our [Guangzhou hospital guide](/blog/hospitals-in-guangzhou-for-international-patients.html) and the [Shanghai and Beijing hospital guides](/blog/hospitals-in-shanghai-for-international-patients.html) list the international patient offices of the major teaching hospitals that run these programmes.
...
1. Has the diagnosis been confirmed by a neurologist, with EMG and blink-reflex testing?
2. Is the symptom pattern more than three months old (the trial's inclusion criterion)?
3. Which acupuncture points does the proposed protocol use, and how many sessions are planned?
4. What is the quoted total cost in writing, including the workup, the course of sessions, and any Western co-management?
5. Will the hospital measure the blink reflex before and after the course, so the result is objective?
6. What eye-care plan is in place for dry eye and exposure keratopathy during the course?
7. Who co-signs the discharge summary, and will it be in English for the referring doctor at home?

A practical next step is to send a recent neurology note, a facial-nerve EMG report, and a short video of the patient's face at rest and during the standard expressions (smile, eye closure, raised forehead) to the international patient office of the hospital that best matches the patient's location. Our [how to prepare for medical travel to China](/blog/how-to-prepare-medical-travel-china.html) and [how to see a doctor in Guangzhou as a foreigner](/blog/how-to-see-a-doctor-in-guangzhou-as-a-foreigner.html) guides walk through the document and visa steps in detail.
...
- [Acupuncture Treatment in China 2026](/blog/acupuncture-treatment-china-2026.html)
- [Traditional Chinese Medicine Guide for International Patients](/blog/tcm-traditional-chinese-medicine-guide.html)
- [Hospitals in Guangzhou for International Patients](/blog/hospitals-in-guangzhou-for-international-patients.html)
- [How to See a Doctor in Guangzhou as a Foreigner](/blog/how-to-see-a-doctor-in-guangzhou-as-a-foreigner.html)
- [Hainan TCM and Wellness Tourism 2026](/blog/hainan-tcm-wellness-tourism-2026.html)
- [How to Prepare for Medical Travel to China](/blog/how-to-prepare-medical-travel-china.html)
