...
title: "Senaparib: China-Approved Ovarian Cancer Drug Now Licensed Across 66 Countries — Cost and Access in China"
description: "China's PARP inhibitor senaparib was licensed to Pharmanovia for 66 countries on July 31, 2026. NRDL pricing, treatment costs, and access for international ovarian cancer patients in China."
  ...
  [
    {
      ...
      "@type": "Article",
      "headline": "Senaparib: China-Approved Ovarian Cancer Drug Now Licensed Across 66 Countries — Cost and Access in China",
      "description": "China's PARP inhibitor senaparib was licensed to Pharmanovia for 66 countries on July 31, 2026. NRDL pricing, treatment costs, and access for international ovarian cancer patients in China.",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://chinahospitalsguide.com/blog/2026-08-05-senaparib-ovarian-cancer-pharmanovia-license-china/"
      }
    },
    {
      "@context": "https://schema.org",
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is senaparib and who is it for?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Senaparib (IMP4297) is a novel PARP1/2 inhibitor independently developed by IMPACT Therapeutics, a Nanjing-founded biotech listed on the Hong Kong Stock Exchange in May 2026. China's NMPA approved it in January 2025 as first-line maintenance therapy for adults with advanced epithelial ovarian, fallopian tube, or primary peritoneal cancer who achieved a complete or partial response to platinum-based chemotherapy."
          }
        },
        {
          "@type": "Question",
          "name": "How much does senaparib cost in China?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Senaparib was added to China's National Reimbursement Drug List (NRDL) in December 2025. NRDL-negotiated oncology prices in China typically run 60-80 percent below US list prices, and the negotiated price anchors what hospitals charge. International patients pay self-pay rates at hospital international departments, but the same NRDL-anchored pricing applies, making maintenance treatment a fraction of the equivalent cost in Singapore, Korea, or Western Europe."
          }
        },
        {
          "@type": "Question",
          "name": "Can international patients access senaparib and ovarian cancer care in China?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Major Chinese cancer centers with international patient departments — including Fudan University Shanghai Cancer Center, Peking Union Medical College Hospital, and Sun Yat-sen University Cancer Center — treat overseas ovarian cancer patients, arrange English interpretation and visa invitation letters, and prescribe senaparib maintenance where clinically indicated. The standard pathway is cytoreductive surgery, platinum-based chemotherapy, then PARP maintenance. Clinical trial options for international patients are also available at leading centers."
          }
        }
      ]
    }
...
pageStyle: |
  .deal-data-box {
    background: linear-gradient(135deg, #eef3f8 0%, #dde8f2 100%);
    border-left: 5px solid #2d5b8c;
    padding: 24px 28px;
    margin: 24px 0;
    border-radius: 0 12px 12px 0;
  }
  .deal-data-box h3 { margin-top: 0; color: #1e4468; }
  .deal-data-box .stat-row {
    display: flex;
    gap: 24px;
    margin: 12px 0;
    flex-wrap: wrap;
  }
  .deal-data-box .stat { flex: 1; min-width: 160px; }
  .deal-data-box .stat-num {
    font-size: 1.5em;
    font-weight: 700;
    color: #2d5b8c;
    display: block;
  }
  .deal-data-box .stat-label { font-size: 0.9em; color: #2a3f54; }
  .access-note {
    background: #fff8e1;
...
On July 31, 2026, IMPACT Therapeutics (07630.HK) — a Nanjing-founded biotech listed on the Hong Kong Stock Exchange just two and a half months earlier — announced an exclusive partnership with Pharmanovia, a global specialty pharmaceutical company, covering senaparib, the PARP1/2 inhibitor China's NMPA approved in January 2025. Pharmanovia receives exclusive rights to manufacture, develop, and commercialize senaparib as maintenance monotherapy for advanced epithelial high-grade ovarian, fallopian tube, and primary peritoneal cancer in 66 countries: all 27 European Union member states, the United Kingdom, Norway, Iceland, Switzerland, Liechtenstein, Australia, New Zealand, and the Middle East and North Africa. [The announcement ran on PR Newswire](https://www.finanznachrichten.de/nachrichten-2026-07/69180452-impact-therapeutics-signs-exclusive-license-agreement-with-pharmanovia-for-senaparib-in-europe-middle-east-and-north-africa-australia-and-new-zealan-008.htm) on the same day.
...
<div class="deal-data-box">

### Senaparib in numbers

<div class="stat-row">
  <div class="stat"><span class="stat-num">Jan 2025</span><span class="stat-label">NMPA approval, first-line maintenance in ovarian cancer</span></div>
  <div class="stat"><span class="stat-num">Dec 2025</span><span class="stat-label">Added to China's NRDL national reimbursement list</span></div>
  <div class="stat"><span class="stat-num">66</span><span class="stat-label">Countries covered by the Pharmanovia license</span></div>
  <div class="stat"><span class="stat-num">EUR 423.5M</span><span class="stat-label">Total deal value including milestones and royalties</span></div>
</div>
...
Leading options for international patients include [Fudan University Shanghai Cancer Center](https://chinahospitalsguide.com/blog/best-cancer-hospitals-china-2026.html) (a national referral center for gynecologic oncology), Peking Union Medical College Hospital in Beijing, and Sun Yat-sen University Cancer Center in Guangzhou. All three run international patient departments that arrange appointments, English interpretation, and visa invitation letters. For a full picture of how the system works for overseas patients, see our [cancer treatment in China guide](https://chinahospitalsguide.com/blog/cancer-treatment-china-2026.html).
...
The realistic comparison for the site's main audiences: an Indonesian, Vietnamese, Russian, or Middle Eastern ovarian cancer patient weighing China against Singapore, Korea, or India will typically find the Chinese pathway cheaper on the drug component and comparable on surgical and hospital costs — with the additional advantage that the specific maintenance drug is already commercially available. Our [cancer treatment cost guide](https://chinahospitalsguide.com/blog/cancer-treatment-cost-china.html) breaks down the full cost picture, and the [why international patients choose China](https://chinahospitalsguide.com/blog/why-international-patients-choose-china-medical-treatment-2026.html) piece explains the structural reasons behind the price gap.
...
1. **Contact the international patient desk** at a major cancer center — Fudan Shanghai, PUMC, or Sun Yat-sen — with the patient's pathology report and imaging. The hospital confirms whether the case is treatable and sends a treatment plan and cost estimate.
2. **Arrange the visa** — medical visa invitation letters are standard practice; [our visa guide](https://chinahospitalsguide.com/blog/china-medical-visa-guide-2026.html) covers the routes, including visa-free entry via Hainan and the 240-hour transit policy.
3. **Treatment timeline** — surgery within days to two weeks of arrival, platinum chemotherapy over the following months, then PARP maintenance, with follow-up monitoring that can be coordinated remotely after the patient returns home.

For patients interested in research options, Chinese cancer centers run active ovarian cancer trials, and international enrollment is possible through the same international departments; our [clinical trials guide](https://chinahospitalsguide.com/blog/car-t-clinical-trials-china-2026.html) explains how that process works.

<div class="access-note">

**The bottom line:** a Chinese-developed PARP inhibitor, already NMPA-approved and NRDL-listed, is about to become a European drug. For international ovarian cancer patients, the window is open now — the same medicine, at China's negotiated prices, with integrated TCM support that no Western center matches. Senaparib's global licensing history is tracked on [clinicaltrials.gov](https://clinicaltrials.gov/search?cond=Ovarian+Cancer&intr=senaparib) and the full license announcement is available on [PR Newswire](https://www.finanznachrichten.de/nachrichten-2026-07/69180452-impact-therapeutics-signs-exclusive-license-agreement-with-pharmanovia-for-senaparib-in-europe-middle-east-and-north-africa-australia-and-new-zealan-008.htm).
...
- [Cancer Treatment Cost in China: What International Patients Pay](/blog/cancer-treatment-cost-china.html)
- [Best Cancer Hospitals in China 2026](/blog/best-cancer-hospitals-china-2026.html)
- [China's Drug Innovation Boom: 76 Innovative Drugs Approved in 2025](/blog/2026-07-30-china-biotech-merck-76-innovative-drugs-record-pipeline-2026/)
- [China Medical Visa Guide 2026: How to Enter for Treatment](/blog/china-medical-visa-guide-2026.html)
