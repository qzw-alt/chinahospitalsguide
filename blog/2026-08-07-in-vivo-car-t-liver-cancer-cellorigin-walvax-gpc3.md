...
title: "In Vivo CAR-T for Liver Cancer Reaches Patients in China: GPC3 mRNA Program + Walvax Manufacturing Deal"
description: "CellOrigin is testing mRNA-LNP 'in vivo CAR' therapy for liver cancer — T cells programmed inside the body, not in a lab. GPC3 target, Walvax manufacturing deal, first patients already dosed in 2026."
  ...
  [
    {
      ...
      "@type": "Article",
      "headline": "In Vivo CAR-T for Liver Cancer Reaches Patients in China: GPC3 mRNA Program + Walvax Manufacturing Deal",
      "description": "CellOrigin is testing mRNA-LNP 'in vivo CAR' therapy for liver cancer — T cells programmed inside the body, not in a lab. GPC3 target, Walvax manufacturing deal, first patients already dosed in 2026.",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://chinahospitalsguide.com/blog/2026-08-07-in-vivo-car-t-liver-cancer-cellorigin-walvax-gpc3/"
      }
    },
    {
      "@context": "https://schema.org",
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is in vivo CAR therapy?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "In vivo CAR therapy uses mRNA wrapped in lipid nanoparticles (mRNA-LNP) to program a patient's own T cells to recognize cancer directly inside the body, rather than removing the cells, engineering them in a laboratory, and infusing them back. Because the CAR is delivered as mRNA, expression is transient and the approach avoids the expensive, slow manufacturing of ex vivo CAR-T products."
          }
        },
        {
          "@type": "Question",
          "name": "What did CellOrigin present at ASCO 2026?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "CellOrigin's team presented two solid-tumor programs: CAR-Mix, which combines engineered macrophages with polyclonal T cells and showed synergistic antitumor activity in a mesothelin-positive ovarian cancer model, with an investigator-initiated study already dosing its first patient in early 2026; and TMT Engager, an LNP-mRNA in vivo T-cell engager that forms T-cell-macrophage-tumor cell conjugates and showed strong efficacy in preclinical liver and ovarian cancer models."
          }
        },
        {
          "@type": "Question",
          "name": "What is the Walvax Biotechnology deal?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "CellOrigin and Walvax Biotechnology signed a co-development agreement to jointly run an investigator-initiated trial of mRNA-LNP in vivo GPC3-CAR therapy for hepatocellular carcinoma. CellOrigin contributes CAR design, pharmacodynamic evaluation, and clinical protocol development; Walvax contributes clinical-grade large-scale manufacturing, process quality systems, and product registration experience."
          }
        },
        {
          "@type": "Question",
          "name": "Can international patients access in vivo CAR therapy in China now?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The GPC3 in vivo CAR program is in the investigator-initiated trial stage, so access is through trial enrollment at participating Chinese centers — arranged through hospital international departments. For approved cell therapy today, China already offers commercial CAR-T including satri-cel, the world's first approved solid-tumor CAR-T, at $89,000-$170,000, versus $300,000-$500,000 in the United States."
          }
        }
      ]
    }
...
<div class="stat-row">
  <div class="stat"><span class="stat-num">CAR-Mix™</span><span class="stat-label">Engineered macrophages + polyclonal T cells; mesothelin-positive ovarian cancer; IIT launched, first patient dosed early 2026</span></div>
  <div class="stat"><span class="stat-num">TMT Engager™</span><span class="stat-label">LNP-mRNA in vivo T-cell engager forming T-cell–macrophage–tumor cell conjugates; efficacy in liver and ovarian cancer models</span></div>
  <div class="stat"><span class="stat-num">GPC3-CAR + Walvax</span><span class="stat-label">Co-development IIT for hepatocellular carcinoma using mRNA-LNP in vivo GPC3-CAR, built on a 2025 ASCO preclinical study</span></div>
</div>
...
CellOrigin's ex vivo sibling in the GPC3 space is worth remembering for context. Oricell's Ori-C101, an ex vivo GPC3 CAR-T for HCC, has been in Chinese trials with striking late-line data, and China's broader [solid tumor CAR-T field](https://chinahospitalsguide.com/blog/solid-tumor-car-t-china.html) now spans approved, in-trial, and in-vivo formats. GPC3 is becoming the shared test antigen for every generation of the technology.
...
The in vivo format, if it delivers on its manufacturing logic, sits below both of those bands: mRNA-LNP is a vaccine-style production process, measured in days rather than the weeks required for autologous cell manufacturing, and the product is an off-the-shelf vial rather than a personalized cell batch. That is why the format matters for medical tourism — the cost structure is the access story. Our [CAR-T cost guide](https://chinahospitalsguide.com/blog/car-t-therapy-china-2026.html) and [clinical trials guide](https://chinahospitalsguide.com/blog/car-t-clinical-trials-china-2026.html) explain the current two-track pricing in detail.
...
Three signals over the next 12-18 months: the first readouts from the CAR-Mix IIT in ovarian cancer (safety already described as well-tolerated, activity to be quantified); dosing in the Walvax co-developed GPC3 in vivo CAR IIT for HCC; and whether the format attracts a global licensing deal — the pattern China's cell therapy field has already established with ex vivo products, where [China-first development and world-class data](https://chinahospitalsguide.com/blog/2026-07-30-china-biotech-merck-76-innovative-drugs-record-pipeline-2026/) have repeatedly preceded global expansion, as the [ivonescimab story](https://chinahospitalsguide.com/blog/2026-08-06-ivonescimab-egfr-lung-cancer-fda-decision-november-2026/) shows in antibodies and the senaparib licensing deal showed in small molecules.
