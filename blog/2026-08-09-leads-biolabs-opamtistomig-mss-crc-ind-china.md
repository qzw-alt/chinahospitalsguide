...
title: "China Clears a New Immunotherapy for 'Cold' Colorectal Cancer: PD-L1 × 4-1BB Bispecific Gets IND for MSS/pMMR mCRC"
description: "China approved Leads Biolabs' Opamtistomig (LBL-024) PD-L1 × 4-1BB bispecific for combination trials in MSS/pMMR metastatic colorectal cancer — the 95% of CRC patients who do not respond to standard checkpoint inhibitors."
  ...
  [
    {
      ...
      "@type": "Article",
      "headline": "China Clears a New Immunotherapy for 'Cold' Colorectal Cancer: PD-L1 × 4-1BB Bispecific Gets IND for MSS/pMMR mCRC",
      "description": "China approved Leads Biolabs' Opamtistomig (LBL-024) PD-L1 × 4-1BB bispecific for combination trials in MSS/pMMR metastatic colorectal cancer — the 95% of CRC patients who do not respond to standard checkpoint inhibitors.",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://chinahospitalsguide.com/blog/2026-08-09-leads-biolabs-opamtistomig-mss-crc-ind-china/"
      }
    },
    {
      "@context": "https://schema.org",
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is Opamtistomig (LBL-024)?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Opamtistomig (LBL-024) is a bispecific antibody developed by China's Leads Biolabs that simultaneously blocks PD-L1 immune suppression and conditionally activates the 4-1BB co-stimulatory pathway on T cells. It is built on the company's X-Body platform and is the first 4-1BB-targeting bispecific antibody globally to advance to a single-arm registration trial as monotherapy."
          }
        },
        {
          "@type": "Question",
          "name": "Why do MSS/pMMR colorectal cancer patients need a new immunotherapy?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Only about 5% of metastatic colorectal cancer cases are microsatellite instability-high (MSI-H) and respond to standard checkpoint inhibitors. The remaining 95% are microsatellite stable (MSS) or mismatch repair proficient (pMMR) — immunologically 'cold' tumors where PD-1/PD-L1 inhibitors alone offer limited benefit. This group has an urgent need for new immunotherapy approaches."
          }
        },
        {
          "@type": "Question",
          "name": "Can international patients join Opamtistomig clinical trials in China?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, in principle. China's major cancer centers accept international patients into ongoing trials through their international departments, which coordinate record review, eligibility screening and treatment planning. The Opamtistomig Phase Ib/II combination study in colorectal cancer is among the programs that international patients with MSS/pMMR mCRC can inquire about."
          }
        },
        {
          "@type": "Question",
          "name": "What other cancers is Opamtistomig being studied in?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Opamtistomig has been evaluated in 13 solid tumor indications in China, including extrapulmonary neuroendocrine carcinoma (EP-NEC), non-small cell lung cancer, small cell lung cancer, biliary tract cancer, ovarian cancer, esophageal squamous cell carcinoma, hepatocellular carcinoma, gastric cancer and triple-negative breast cancer. It holds NMPA Breakthrough Therapy Designation and FDA Orphan Drug Designation for neuroendocrine carcinoma."
          }
        }
      ]
    }
...
pageStyle: |
  .crc-data-box {
    ...
    border-left: 5px solid #2c5fa8;
    padding: 24px 28px;
    margin: 24px 0;
    border-radius: 0 12px 12px 0;
  }
  .crc-data-box h3 { margin-top: 0; color: #1e3f73; }
  .crc-data-box .stat-row {
    display: flex;
    gap: 24px;
    margin: 12px 0;
    flex-wrap: wrap;
  }
  .crc-data-box .stat { flex: 1; min-width: 160px; }
  .crc-data-box .stat-num {
    font-size: 1.5em;
    font-weight: 700;
    color: #2c5fa8;
    display: block;
  }
  .crc-data-box .stat-label { font-size: 0.9em; color: #243a5e; }
  .access-note {
    background: #fff8e1;
...
In the first week of August 2026, Nanjing-based **Leads Biolabs** announced that China's National Medical Products Administration (NMPA) cleared an Investigational New Drug (IND) application for **Opamtistomig (LBL-024)** — a PD-L1 × 4-1BB bispecific antibody — to be studied **in combination therapy for metastatic colorectal cancer (mCRC)**. [The company confirmed the clearance in a press release](https://markets.businessinsider.com/news/stocks/leads-biolabs-pd-l1-4-1bb-bispecific-antibody-ind-application-for-combination-therapy-in-metastatic-colorectal-cancer-approved-further-strengthening-gastrointestinal-oncology-franchise-1036396166) distributed in early August 2026.
...
<div class="crc-data-box">

### The numbers that frame the story

<div class="stat-row">
  <div class="stat"><span class="stat-num">95%</span><span class="stat-label">of mCRC cases are MSS/pMMR — cold tumors largely invisible to standard checkpoint inhibitors</span></div>
  <div class="stat"><span class="stat-num">&lt;13%</span><span class="stat-label">5-year survival rate for metastatic colorectal cancer</span></div>
  <div class="stat"><span class="stat-num">517,100</span><span class="stat-label">new colorectal cancer cases in China in 2022 (China National Cancer Center), ranking second in incidence</span></div>
  <div class="stat"><span class="stat-num">1st</span><span class="stat-label">4-1BB-targeting bispecific worldwide to reach a single-arm registration trial as monotherapy</span></div>
</div>
...
China's regulatory environment has made it the proving ground for this generation of bispecific immunotherapy. The NMPA has cleared IND applications for dozens of next-generation immuno-oncology assets built by domestic biotechs — Leads Biolabs, with 14 drug candidates across bispecific, ADC and T-cell-engager platforms, is one of a cohort that includes [cell therapy developers now testing in vivo CAR approaches](https://chinahospitalsguide.com/blog/2026-08-07-in-vivo-car-t-liver-cancer-cellorigin-walvax-gpc3/) and [solid-tumor CAR-T programs](https://chinahospitalsguide.com/blog/solid-tumor-car-t-china.html). The same ecosystem that produced the world's first approved solid-tumor CAR-T in mid-2026 is now pushing bispecifics into the hardest colorectal subtype. For patients, the practical consequence is simple: [the newest immunotherapy trials in the world are enrolling in China](https://chinahospitalsguide.com/blog/car-t-clinical-trials-china-2026.html), often years before equivalent programs open in other markets.
...
**Second, the cost structure is different.** Clinical-trial participation in China typically covers the investigational drug at no charge, with patients bearing hospital and supportive-care costs — a fraction of what equivalent experimental therapy would cost in the United States or Singapore. For patients not eligible for trials, [cancer treatment in China remains a fraction of Western pricing](https://chinahospitalsguide.com/blog/cancer-treatment-china-2026.html), and [China's top cancer hospitals](https://chinahospitalsguide.com/blog/best-cancer-hospitals-china-2026.html) run the international departments that coordinate care for Southeast Asian, Central Asian and Middle Eastern patients — the site's core readership.
...
- [Solid-Tumor CAR-T in China: The State of the Field](/blog/solid-tumor-car-t-china.html)
- [In Vivo CAR-T for Liver Cancer Reaches Patients in China](/blog/2026-08-07-in-vivo-car-t-liver-cancer-cellorigin-walvax-gpc3/)
