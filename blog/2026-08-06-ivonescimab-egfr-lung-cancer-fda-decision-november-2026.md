...
title: "Ivonescimab Cuts EGFR Lung Cancer Death Risk 24%: FDA Decision Due November 14, 2026"
description: "Updated HARMONi data show China-developed ivonescimab cut death risk 24% in EGFR-mutant lung cancer. FDA decision November 14, 2026; the drug is already in routine use in China."
kicker: "China Drug Innovation & Lung Cancer"
  ...
  [
    {
      ...
      "@type": "Article",
      "headline": "Ivonescimab Cuts EGFR Lung Cancer Death Risk 24%: FDA Decision Due November 14, 2026",
      "description": "Updated HARMONi data show China-developed ivonescimab cut death risk 24% in EGFR-mutant lung cancer. FDA decision November 14, 2026; the drug is already in routine use in China.",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://chinahospitalsguide.com/blog/2026-08-06-ivonescimab-egfr-lung-cancer-fda-decision-november-2026/"
      }
    },
    {
      "@context": "https://schema.org",
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is ivonescimab and where did it come from?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Ivonescimab is a first-in-class PD-1/VEGF bispecific antibody developed by Akeso, a biopharmaceutical company based in Zhongshan, Guangdong, China. China's NMPA approved it in May 2024 for EGFR-mutant advanced non-small cell lung cancer after EGFR-TKI therapy — the first PD-1/VEGF bispecific approved anywhere in the world. Summit Therapeutics licensed rights outside Greater China in late 2022 and is running the global HARMONi trial program."
          }
        },
        {
          "@type": "Question",
          "name": "What did the updated HARMONi results show?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "In the analysis with a June 2026 data cutoff, ivonescimab plus chemotherapy reduced the risk of death by 24 percent compared with chemotherapy alone (hazard ratio 0.76) in EGFR-mutant non-small cell lung cancer after progression on a third-generation EGFR inhibitor. The benefit was identical in the overall patient population and in the Europe/North America subgroup, whose median follow-up had matured to 23.2 months."
          }
        },
        {
          "@type": "Question",
          "name": "Can international patients get ivonescimab in China today?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Ivonescimab has been commercially available in China since its NMPA approval in May 2024 and is prescribed across major Chinese cancer centers, with prices anchored by the national reimbursement drug list negotiation. International patients can access it through hospital international departments at major lung cancer centers such as Shanghai Chest Hospital, Zhongshan Hospital Fudan University, and Guangdong Provincial People's Hospital. Outside China, the drug is currently available mainly through clinical trials until regulatory decisions land."
          }
        },
        {
          "@type": "Question",
          "name": "When will the FDA decide on ivonescimab?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Summit Therapeutics reported on August 5, 2026 that the updated HARMONi survival results were submitted to the US Food and Drug Administration, which is expected to issue its decision on the biologics license application by November 14, 2026."
          }
        }
      ]
    }
...
<div class="stat-row">
  <div class="stat"><span class="stat-num">0.76</span><span class="stat-label">Hazard ratio for overall survival, ivonescimab + chemo vs chemo alone (June 2026 cutoff)</span></div>
  <div class="stat"><span class="stat-num">24%</span><span class="stat-label">Relative reduction in risk of death — consistent in Western and Asian patients</span></div>
  <div class="stat"><span class="stat-num">6.8 vs 4.4 mo</span><span class="stat-label">Median progression-free survival, ivonescimab + chemo vs chemo</span></div>
  <div class="stat"><span class="stat-num">Nov 14, 2026</span><span class="stat-label">Expected FDA decision on the ivonescimab biologics license application</span></div>
</div>
...
1. **Commercial treatment** — ivonescimab-based regimens are available now at major lung cancer centers, including Shanghai Chest Hospital, Zhongshan Hospital Fudan University, and Guangdong Provincial People's Hospital. Treatment plans and cost estimates come from the hospital's international department; our [best cancer hospitals guide](https://chinahospitalsguide.com/blog/best-cancer-hospitals-china-2026.html) covers how to choose, and the [cancer treatment cost guide](https://chinahospitalsguide.com/blog/cancer-treatment-cost-china.html) explains the price picture.
2. **Trial participation** — HARMONi program sites and the AK138D1 combination studies enroll through Chinese centers; enrollment is arranged through the same international departments.
3. **The sequencing decision** — for patients who have not yet failed an EGFR inhibitor, the first-line question (TKI alone versus TKI-plus combinations) is a live medical decision, and second opinions at Chinese centers are inexpensive relative to the same consultation in Singapore or Hong Kong.

The [cancer treatment in China guide](https://chinahospitalsguide.com/blog/cancer-treatment-china-2026.html) walks through the full pathway, and our [visa guide](https://chinahospitalsguide.com/blog/china-medical-visa-guide-2026.html) covers entry routes, including visa-free transit and Hainan. For patients weighing whether to wait for the FDA decision before committing to treatment abroad: the drug will not be cheaper in the United States than in China, and the November 14 date does not change what is already available at Chinese hospitals today.

## The China-Specific Extra: Integrated Supportive Care

Chinese lung cancer centers add a layer most Western hospitals do not: integrated Chinese-Western medicine (中西医结合) running alongside the oncology protocol. During an ivonescimab-plus-chemo course, Chinese teams routinely add acupuncture for chemotherapy-induced nausea and peripheral neuropathy, herbal formulas to manage fatigue and appetite loss, and post-infusion recovery protocols — adjunctive symptom management delivered inside the same hospital by the same care team, not alternative treatment standing in for the regimen. The nausea evidence is among the best-documented in acupuncture research, and for a patient facing months of platinum-based therapy the difference in day-to-day tolerance is measurable. Our [integrated Chinese-Western medicine guide](https://chinahospitalsguide.com/blog/integrated-chinese-western-medicine-china.html) and the [TCM in China guide](https://chinahospitalsguide.com/blog/tcm-traditional-chinese-medicine-guide.html) explain how these services are booked and what they cost.

## What to Watch Next

Three dates and data points matter over the next six months: the FDA decision on or before November 14, 2026; the full June 2026 HARMONi survival data — medians, confidence intervals, and p-values — which Summit says will be presented at a future medical congress; and the first readouts from the HARMONi-GU1 bladder cancer program. For the broader China pipeline picture, [the record 2025 approval year](https://chinahospitalsguide.com/blog/2026-07-30-china-biotech-merck-76-innovative-drugs-record-pipeline-2026/) and [the senaparib licensing deal](https://chinahospitalsguide.com/blog/2026-08-05-senaparib-ovarian-cancer-pharmanovia-license-china/) show the same pattern: China-first approval, world-class trial data, then global expansion. Ivonescimab is simply the furthest along.

<div class="access-note">

**The bottom line:** a Chinese bispecific that has been treating EGFR-mutant lung cancer patients in China since 2024 now has registration-quality survival data — HR 0.76, a 24 percent reduction in death risk, consistent across regions — and an FDA decision date of November 14, 2026. International patients who need this drug today can get it at Chinese cancer centers at negotiated prices, with integrated TCM supportive care, while the rest of the world waits on regulators. Trial and commercial tracking for the program is available on [clinicaltrials.gov](https://clinicaltrials.gov/search?cond=Lung+Cancer&intr=ivonescimab) and the [Akeso newsroom](https://www.akesobio.com/en/media/akeso-news/260728/).
...
- [Why International Patients Choose China for Medical Treatment](/blog/why-international-patients-choose-china-medical-treatment-2026.html)
